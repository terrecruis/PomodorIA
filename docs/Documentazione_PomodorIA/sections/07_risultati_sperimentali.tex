...
misurati sul test set corretto (Sezione~\ref{sec:compressione}) tramite la
suite di benchmark automatizzata (\texttt{benchmarks/benchmark\_compression.py}),
eseguita a valle della risoluzione delle problematiche tecniche descritte
