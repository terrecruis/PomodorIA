...
esplicitamente ai concetti teorici del corso di Internet of Things
...
sperimentale che ha portato all'identificazione e alla risoluzione di
problematiche tecniche non evidenti a un primo sguardo (il \emph{data
leakage} nella valutazione dell'accuratezza e il fallimento silenzioso della
quantizzazione ONNX, discussi nella Sezione~\ref{sec:compressione}),
un aspetto che riteniamo rappresenti un valore aggiunto significativo
rispetto alla sola esecuzione di una pipeline preconfezionata.
