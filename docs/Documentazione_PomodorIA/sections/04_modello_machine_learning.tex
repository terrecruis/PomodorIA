...
da zero nell'ambito di questo progetto, ma proviene da un esame
precedente~\ref{bib:cnntomato}: una rete convoluzionale (CNN) allenata sul
dataset \textbf{PlantVillage -- Tomato}~\ref{bib:dataset} (14.529 immagini,
10 classi: 9 patologie fogliari più la classe "sana").
